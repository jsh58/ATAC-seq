...
Model-based Analysis of ChIP-Seq ([MACS2](https://github.com/taoliu/MACS)) is a program for detecting regions of genomic enrichment.  Though designed for ChIP-seq, it works just as well on ATAC-seq and other genome-wide enrichment assays that have narrow peaks.  The main program in MACS2 is `callpeak`, and its options are described below.  (Note that the latest version of MACS2 on Odyssey ([v2.1.2_dev](https://github.com/jsh58/MACS/releases/tag/v2.1.2_dev)) is different from the updated official MACS2 release ([v2.1.2](https://github.com/taoliu/MACS/releases/tag/v2.1.2)), although the latter does incorporate many of the [bug fixes](https://github.com/taoliu/MACS/pull/240) made in the Odyssey version.)
...
<table>
  ...
  <tr>
    ...
    <td>Maximum <i>q</i>-value (FDR-adjusted <i>p</i>-value) for peak calling (default 0.05).  Reducing this threshold will decrease the number of peaks identified by MACS2 but increase the confidence in the called peaks.</td>
  </tr>
  <tr>
